...
def ToMetric(wd):
    new_data =copy.copy(wd)
    new_data['tmin'] =ToC(wd['tmin'])
    new_data['tmax'] =ToC(wd['tmax'])
    new_data['prcp'] =ToMM(wd['prcp'])
    new_data['snow'] =ToMM(wd['snow'])
    new_data['snwd'] =ToMM(wd['snwd'])
    new_data['awnd'] =ToKPH(wd['awnd'])
    return new_data
